...
.e-kanban .e-frozen-swimlane-row .e-frozen-row .e-swimlane-header .e-swimlane-row-collapse:focus {
  ...
  border: 1px solid var(--color-sf-base-transparent);
  border-radius: 4px;
  -webkit-box-shadow: 0 0 0 1px rgba(var(--color-sf-brand-primary), 1);
          box-shadow: 0 0 0 1px rgba(var(--color-sf-brand-primary), 1);
...
.e-kanban .e-kanban-header .e-header-cells.e-min-color {
  background: var(--color-sf-utility-msg-warning-bg-color);
}
.e-kanban .e-kanban-header .e-header-cells.e-max-color {
  background: var(--color-sf-utility-msg-danger-bg-color);
}
...
.e-kanban .e-kanban-content .e-content-row .e-content-cells .e-show-add-button:focus {
  ...
  color: var(--color-sf-border-primary-alt);
}
...
.e-kanban .e-kanban-content .e-content-row .e-content-cells .e-card-container .e-card.e-selection {
  border: 1px solid var(--color-sf-border-secondary);
  -webkit-box-shadow: 0 4px 6px -1px rgba(var(--color-sf-base-black), 0.05), 0 10px 15px -3px rgba(var(--color-sf-base-black), 0.1);
          box-shadow: 0 4px 6px -1px rgba(var(--color-sf-base-black), 0.05), 0 10px 15px -3px rgba(var(--color-sf-base-black), 0.1);
}
...
.e-kanban .e-kanban-content .e-content-row .e-content-cells .e-card-container .e-multi-card-clone {
  border: 1px solid var(--color-sf-border-primary-alt);
  height: 34px;
}
...
.e-kanban .e-kanban-content .e-content-row .e-content-cells .e-target-multi-clone .e-column-key {
  border-bottom: 1px dashed var(--color-sf-border-primary-alt);
  border-left: 1px dashed var(--color-sf-border-primary-alt);
  border-right: 1px dashed var(--color-sf-border-primary-alt);
}
...
.e-kanban .e-kanban-content .e-content-row .e-content-cells .e-target-multi-clone .e-column-key:first-child {
  border-top: 1px dashed var(--color-sf-border-primary-alt);
}
...
.e-kanban-dialog.e-dialog .e-kanban-form-wrapper table textarea:focus {
  -webkit-box-shadow: 0 0 0 2px var(--color-sf-brand-primary);
          box-shadow: 0 0 0 2px var(--color-sf-brand-primary);
}
